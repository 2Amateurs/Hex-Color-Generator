...
nouns=["blue","yellow","magenta","green","brown","turquoise","white","red","orange","gray","black","scarlet","mustard","ketchup","pumpkin","who-knows","dirt","purple","violet","indigo","maroon","skunk","giraffe","insect","cell tissue","garbage","lorax","sparkly pink"]
